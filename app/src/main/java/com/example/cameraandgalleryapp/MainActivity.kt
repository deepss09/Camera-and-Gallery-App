...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val takePhoto: Button = findViewById(R.id.camera_button)
        val chooseFromAlbum: Button = findViewById(R.id.gallery_button)
        ...
        when(requestCode){
            FINAL_TAKE_PHOTO ->
                if (resultCode == Activity.RESULT_OK) {
                    val bitmap = BitmapFactory.decodeStream(imageUri?.let { getContentResolver().openInputStream(it) })
